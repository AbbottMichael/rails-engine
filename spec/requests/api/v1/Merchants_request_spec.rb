...
describe 'Merchants API' do
  ...
  describe 'Merchants with the most items' do
    before :each do
      @customer1 = create(:customer)
      @merchant1 = create(:merchant)
      @item1 = create(:item, merchant_id: @merchant1.id)
    ...
    it 'sends back a chosen number of merchants ranked by most items in descending order' do
  ...
  describe 'Total revenue for a given merchant' do
    before :each do
      @customer1 = create(:customer)
      @merchant1 = create(:merchant)
      @item1 = create(:item, merchant_id: @merchant1.id)
    ...
    it 'sends back the total revenue for a single merchant' do
